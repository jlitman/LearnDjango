...
def create_question(question_text, days):
    '''creates a question with the given text and published the
...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        '''was_published_recently shoudl return False for questions 
    ...
    def test_was_published_recently_with_recent_question(self):
        '''was_published_recently shoulde return True for questions
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_future_question_and_past_question(self):
        '''Even if both past and present questions exist, only past questions
           should be displayed.'''
        create_question(question_text="Past question", days=-30)
        create_question(question_text="Future question", days=30)
        response = self.client.get(reverse('polls:index'))
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_past_question(self):
        ...
        response =\
           self.client.get(reverse('polls:detail',args=(past_question.id,)))
